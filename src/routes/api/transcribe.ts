    ...
    handlers: {
      POST: async ({ request }) => {
        ...
        const derjaPrompt =
          ...
          "أمثلة فرنسي/إنجليزي لازم تبقى Latin: lycée, école, produit, montage, business, marketing, problème, service, réseau, rendez-vous, téléphone, ordinateur, boutique, email, wifi, download, link. " +
